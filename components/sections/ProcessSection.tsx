...
const steps = [
  {
    ...
    description: "We remove any existing structure and clear the site completely, preparing a flawless foundation canvas.",
  },
  {
    id: 2,
    icon: Ruler,
    title: "Precision Foundation",
    description: "Mathematical precision. Leveling and pouring of a rock-solid concrete foundation built to withstand generations.",
  },
  {
    id: 3,
    icon: Hammer,
    title: "Amish-Quality Construction",
    description: "Our skilled craftsmen hand-build your garage using premium materials, traditional joinery, and architectural framing.",
  },
  {
    id: 4,
    icon: Zap,
    title: "Electrical & Finishing",
    description: "Professional electrical installation, flawless exterior finishing, and a rigorous multi-point quality inspection.",
  },
];
...
function ProcessCard({ step, index, scrollYProgress }: { step: any, index: number, scrollYProgress: any }) {
  ...
  return (
    <div className={`w-screen h-full flex items-center justify-center flex-shrink-0 bg-transparent relative px-4 sm:px-8`}>
